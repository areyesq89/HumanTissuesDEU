...
vignette: >
  %\VignetteIndexEntry{HumanDEU revisions}
...
```{r reucsATP11B, fig.height=1.8, fig.width=3.5}
...
```{r reucsATP11B_2, fig.width=3.5, fig.height=2.5}
...
```{r reucsTPD52, fig.width=4.2, fig.height=1.8}
...
```{r reucsSLC25A3, fig.width=4, fig.height=1.8}
...
```{r reucsSLC25A3_2, fig.width=3.5, fig.height=2.5}
...
```{r reucsNDUFV3, fig.width=4, fig.height=1.8}
...
```{r reucsNDUFV3_2, fig.width=3.5, fig.height=2.5} 
samples <- HumanDEU:::getSampleIdentifiers(
...
```{r reucsSGCE, fig.width=3.5, fig.height=1.8}
...
```{r reucsSGCE_2, fig.width=3.5, fig.height=2.5}
...
```{r reucsMYO1C, fig.width=4.2, fig.height=1.8}
...
```{r reucsMYO1C_2, fig.width=3.5, fig.height=2.5}
...
```{r ATP5C1, fig.width=3.6, fig.height=1.8}
...
```{r ATP5C1_2, fig.width=3.5, fig.height=2.5}
...
```{r ANK3, fig.width=6.5, fig.height=4}
...
```{r ANK3b, fig.width=3.6, fig.height=1.8}
...
```{r ANK3_2, fig.width=3.5, fig.height=2.5}
...
```{r reucsMEF2C, fig.width=6.5, fig.height=4}
...
```{r reucsMEF2C_2, fig.width=3.5, fig.height=2.5}
...
```{r KSR1, fig.width=4.2, fig.height=1.8}
...
```{r KSR1_2, fig.width=3.5, fig.height=2.5}
